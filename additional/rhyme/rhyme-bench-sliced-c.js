...
if (args[2]) settings.compiler = args[2]
if (args[3]) settings.cFlags = args[3]

//console.log(args)


for (let i = 1; i <= 10; i++) {
  q1(`"../data/sliced/commits_${i}000.json"`, `${i}000`)
}
